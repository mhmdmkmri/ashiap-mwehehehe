(function () {
  ...
  const translations = {
    id: {
      ...
      navPreview: "Preview",
      navContact: "Kontak",
      headerContactCta: "Hubungi Kami",
      languageLabel: "Bahasa",
      heroEyebrow: "Platform Koordinasi Project",
      heroTitle: "Koordinasi project yang rapi, cepat, dan jelas.",
      heroBody: "Semua progres, prioritas, dan tindak lanjut ada dalam satu dashboard.",
      ...
      stageBrandText: "Pratinjau dashboard MARK.",
      heroMini1Title: "Arah kerja lebih jelas",
      heroMini1Text: "Arah kerja langsung terlihat.",
      heroMini2Title: "Koordinasi lebih terkendali",
      heroMini2Text: "Update tim lebih mudah diikuti.",
      heroMini3Title: "Pelaporan lebih meyakinkan",
      heroMini3Text: "Laporan siap dibahas kapan saja.",
      ...
      stat1Text: "Semua project dalam satu alur.",
      stat2Title: "Progres lebih terbaca",
      stat2Text: "Kondisi project cepat dipahami.",
      stat3Title: "Koordinasi lebih efisien",
      stat3Text: "Koordinasi harian lebih efisien.",
      stat4Title: "Presentasi lebih siap",
      stat4Text: "Ringkasan siap untuk stakeholder.",
      mainSectionKicker: "Ikhtisar Produk",
      mainSectionTitle: "Semua fitur utama dalam tab sederhana.",
      mainSectionText: "Lihat ringkasan, fitur, preview, dan kontak secara cepat.",
      ...
      overviewCard1Text: "Fokus kerja dan progres lebih mudah dipantau.",
      ...
      overviewCard2Text: "Nyaman untuk tim operasional dan manajemen.",
      ...
      overviewCard3Text: "Mendukung alur dari planning sampai reporting.",
      ...
      floatingContactLabel: "Butuh demo cepat?",
    ...
    en: {
      ...
      heroTitle: "Project coordination that is clear, fast, and structured.",
      heroBody: "Track progress, priorities, and follow-ups from one dashboard.",
      ...
      stageBrandText: "Preview of the MARK dashboard.",
      heroMini1Title: "Clearer direction of work",
      heroMini1Text: "Work direction is instantly clear.",
      heroMini2Title: "Better-controlled coordination",
      heroMini2Text: "Team updates are easy to follow.",
      heroMini3Title: "More convincing reporting",
      heroMini3Text: "Reports are ready anytime.",
      ...
      stat1Text: "Projects in one flow.",
      stat2Title: "Progress is easier to read",
      stat2Text: "Status is quick to read.",
      stat3Title: "More efficient coordination",
      stat3Text: "Daily coordination is smoother.",
      stat4Title: "Better presentation readiness",
      stat4Text: "Presentation-ready summaries.",
      mainSectionKicker: "Product Overview",
      mainSectionTitle: "Core information in simple tabs.",
      mainSectionText: "Browse overview, features, previews, and contact quickly.",
      ...
      overviewCard1Text: "Work focus and progress are easier to track.",
      ...
      overviewCard2Text: "Comfortable for operations and management.",
      ...
      overviewCard3Text: "Supports flow from planning to reporting.",
      ...
      floatingContactLabel: "Need a quick demo?",
